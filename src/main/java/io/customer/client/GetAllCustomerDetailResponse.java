 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CustomerDetail" type="{http://customer.io}CustomerDetailType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetAllCustomerDetailResponse {
    ...
    protected List<CustomerDetailType> customerDetail;
     ...
     * 
     */
    public List<CustomerDetailType> getCustomerDetail() {
        if (customerDetail == null) {
            customerDetail = new ArrayList<CustomerDetailType>();
        }
